...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__40927){
...
var request = map__40928__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40928__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__40935 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40935.cljs$core$IFn$_invoke$arity$1 ? fexpr__40935.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40935.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__40936 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__40936.cljs$core$IFn$_invoke$arity$1 ? fexpr__40936.cljs$core$IFn$_invoke$arity$1(response) : fexpr__40936.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__40938){
...
var request = map__40939__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40939__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
