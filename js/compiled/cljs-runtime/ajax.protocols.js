...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k40572,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40572,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__40577){
var vec__40578 = p__40577;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40578,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40571){
var self__ = this;
var G__40571__$1 = this;
return (new cljs.core.RecordIter((0),G__40571__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__40581 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__40581(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40573,other40574){
var self__ = this;
var this40573__$1 = this;
return (((!((other40574 == null)))) && ((this40573__$1.constructor === other40574.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.status,other40574.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.body,other40574.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.status_text,other40574.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.headers,other40574.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.was_aborted,other40574.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40573__$1.__extmap,other40574.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__40571){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__40582 = cljs.core.keyword_identical_QMARK_;
var expr__40583 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__40585 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__40586 = expr__40583;
return (pred__40582.cljs$core$IFn$_invoke$arity$2 ? pred__40582.cljs$core$IFn$_invoke$arity$2(G__40585,G__40586) : pred__40582.call(null,G__40585,G__40586));
})())){
return (new ajax.protocols.Response(G__40571,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__40587 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__40588 = expr__40583;
return (pred__40582.cljs$core$IFn$_invoke$arity$2 ? pred__40582.cljs$core$IFn$_invoke$arity$2(G__40587,G__40588) : pred__40582.call(null,G__40587,G__40588));
})())){
return (new ajax.protocols.Response(self__.status,G__40571,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__40589 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__40590 = expr__40583;
return (pred__40582.cljs$core$IFn$_invoke$arity$2 ? pred__40582.cljs$core$IFn$_invoke$arity$2(G__40589,G__40590) : pred__40582.call(null,G__40589,G__40590));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__40571,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__40591 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__40592 = expr__40583;
return (pred__40582.cljs$core$IFn$_invoke$arity$2 ? pred__40582.cljs$core$IFn$_invoke$arity$2(G__40591,G__40592) : pred__40582.call(null,G__40591,G__40592));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__40571,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__40593 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__40594 = expr__40583;
return (pred__40582.cljs$core$IFn$_invoke$arity$2 ? pred__40582.cljs$core$IFn$_invoke$arity$2(G__40593,G__40594) : pred__40582.call(null,G__40593,G__40594));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__40571,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__40571),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__40571){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__40571,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__40575){
var extmap__4478__auto__ = (function (){var G__40595 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__40575,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__40575),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__40575),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__40575),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__40575),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__40575),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
