...
var G__44087 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__44087;
continue;
} else {
return ch;
...
var vec__44029 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44029,(0),null);
return (match === s);
});
...
var G__44118 = (i__4790__auto___44116 + (1));
i__4790__auto___44116 = G__44118;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq44058){
...
return (function() { 
var G__44125__delegate = function (rdr,_){
...
var G__44125 = function (rdr,var_args){
var _ = null;
...
while (G__44128__i < G__44128__a.length) {G__44128__a[G__44128__i] = arguments[G__44128__i + 1]; ++G__44128__i;}
  _ = new cljs.core.IndexedSeq(G__44128__a,0,null);
} 
return G__44125__delegate.call(this,rdr,_);};
G__44125.cljs$lang$maxFixedArity = 1;
G__44125.cljs$lang$applyTo = (function (arglist__44130){
var rdr = cljs.core.first(arglist__44130);
var _ = cljs.core.rest(arglist__44130);
return G__44125__delegate(rdr,_);
});
