...
var periods__$1 = cljs.core.vec((function (){var G__53615 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53613_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__53613_SHARP_,(0),(3));
}),G__53615);
} else {
return G__53615;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__53622){
var vec__53623 = p__53622;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53623,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53623,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__53626 = pattern;
switch (G__53626) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53626)].join('')));
...
switch (G__53639__$1) {
case "millis":
return (function (p1__53628_SHARP_){
return p1__53628_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__53629_SHARP_){
return p1__53629_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__53630_SHARP_){
return p1__53630_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__53631_SHARP_){
return p1__53631_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__53632_SHARP_){
return p1__53632_SHARP_.getHours();
});

break;
case "day":
return (function (p1__53633_SHARP_){
return p1__53633_SHARP_.getDate();
});

break;
case "month":
return (function (p1__53634_SHARP_){
return p1__53634_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__53636_SHARP_){
return p1__53636_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53639__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__53643){
...
break;
case "ordinal-suffix":
var vec__53655 = (function (){var G__53659 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__53659) : syntax_list.call(null,G__53659));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53655,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53647__$1)].join('')));
...
var d = value;
var G__53679 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__53683 = G__53679;
...
var unparser = first__53685;
var more = seq__53684__$1;
var s = "";
var d__$1 = d;
var G__53679__$1 = G__53679;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__53702 = G__53679__$1;
var seq__53703 = cljs.core.seq(vec__53702);
var first__53704 = cljs.core.first(seq__53703);
var seq__53703__$1 = cljs.core.next(seq__53703);
var unparser__$1 = first__53704;
var more__$1 = seq__53703__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__53705 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53705,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53705,(1),null);
var G__53756 = d__$3;
var G__53757 = more__$1;
var G__53758 = s__$3;
d__$1 = G__53756;
G__53679__$1 = G__53757;
s__$1 = G__53758;
continue;
}
break;
