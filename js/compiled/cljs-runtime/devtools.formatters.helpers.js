...
var G__41406 = devtools.prefs.pref(v);
v = G__41406;
continue;
} else {
return v;
...
}catch (e41364){var _e__40814__auto__ = e41364;
return false;
}})();
...
}catch (e41371){var _e__40814__auto__ = e41371;
return false;
}})();
...
}catch (e41374){var _e__40814__auto__ = e41374;
return false;
}}
}
});
...
var vec__41395 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41395,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41395,(1),null);
...
return cljs.core.some((function (p1__41400_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41400_SHARP_);
}),template);
});
