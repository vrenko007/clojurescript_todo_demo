...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41409){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41427_SHARP_){
return (!((cljs.core.meta(p1__41427_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41441__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41445){var _e__40814__auto__ = e41445;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e41447){var _e__40814__auto__ = e41447;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41449 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41450 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41450);

try{var map__41451 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41451__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41449);
}});
...
var temp__5733__auto___41500 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41500)){
var managed_print_level_41501 = temp__5733__auto___41500;
var _STAR_print_level_STAR__orig_val__41461_41502 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41462_41503 = managed_print_level_41501;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41462_41503);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41458_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41458_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41461_41502);
}} else {
job_fn();
}
