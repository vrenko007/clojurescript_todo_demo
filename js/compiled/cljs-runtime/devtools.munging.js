...
var o41036 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41036["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41037 = temp__5733__auto____$1;
return (o41037["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40804__auto__ = f;
return (o__40804__auto__["toString"]).call(o__40804__auto__);
} else {
return "";
}
}catch (e41038){var _ = e41038;
return "";
}});
...
try{var o__40804__auto___41345 = t;
(o__40804__auto___41345["cljs$lang$ctorPrWriter"]).call(o__40804__auto___41345,t,writer);
}catch (e41052){var __41346 = e41052;
}
...
var char_code = (function (){var o__40804__auto__ = (new String(char$));
return (o__40804__auto__["charCodeAt"]).call(o__40804__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40804__auto__ = String;
return (o__40804__auto__["fromCharCode"]).call(o__40804__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41054 = num_code;
switch (G__41054) {
case (1):
return (185);
...
var o__40804__auto__ = String;
return (o__40804__auto__["fromCharCode"]).call(o__40804__auto__,superscript_code);
});
/**
...
}catch (e41070){var _e__40814__auto__ = e41070;
return false;
}})())){
...
var vec__41072 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41072,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o41090 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41090["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41091 = temp__5733__auto____$1;
return (o41091["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___41384 = arguments.length;
var i__4790__auto___41385 = (0);
while(true){
if((i__4790__auto___41385 < len__4789__auto___41384)){
args__4795__auto__.push((arguments[i__4790__auto___41385]));

var G__41386 = (i__4790__auto___41385 + (1));
i__4790__auto___41385 = G__41386;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41112){
var vec__41114 = p__41112;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41114,(0),null);
...
var G__41387 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41388 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41387;
remaining_tokens = G__41388;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41103){
...
var vec__41126 = cljs.core.split_with((function (p1__41125_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41125_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41126,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41126,(1),null);
...
var vec__41135 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41135,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41135,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41393 = cljs.core.rest(remaining_tokens);
var G__41394 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41393;
name_tokens = G__41394;
continue;
} else {
...
var vec__41152 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41152,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41152,(1),null);
var vec__41155 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41155,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41155,(1),null);
var vec__41158 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41158,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41158,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41158,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41158,(3),null);
...
var vec__41174 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41174,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41184 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41184,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41184,(1),null);
var vec__41187 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41187,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41187,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41190 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41190) : devtools.munging.parse_fn_info_deep.call(null,G__41190));
})()));
}
} else {
return fn_info;
...
var G__41407 = (arity + (1));
var G__41408 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41210){
var vec__41213 = p__41210;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41213,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41213,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41229_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41229_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41230_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41230_SHARP_);
}),sorted_infos);
...
args__4795__auto__.push((arguments[i__4790__auto___41420]));

var G__41425 = (i__4790__auto___41420 + (1));
i__4790__auto___41420 = G__41425;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41241){
var vec__41242 = p__41241;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41242,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41238){
var G__41239 = cljs.core.first(seq41238);
var seq41238__$1 = cljs.core.next(seq41238);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41239,seq41238__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41263__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41263__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41263__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41263__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41264 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41264,(5),null);
...
var o__40804__auto__ = f;
return (o__40804__auto__["getBasis"]).call(o__40804__auto__);
});
/**
...
}catch (e41274){var _e__40814__auto__ = e41274;
...
var G__41436 = (obj[cljs.core.first(path)]);
var G__41437 = cljs.core.rest(path);
obj = G__41436;
path = G__41437;
continue;
} else {
...
var _STAR_ = (function (accum,p__41293){
var vec__41296 = p__41293;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41296,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41318){
var vec__41322 = p__41318;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41322,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41322,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41322,(2),null);
...
var post_process = (function (p__41332){
var vec__41333 = p__41332;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41333,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41333,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41328_SHARP_){
return (obj[cljs.core.first(p1__41328_SHARP_)]);
}),sorted_matches);
