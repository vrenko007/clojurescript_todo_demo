...
if((i < len)){
var k = (ks[i]);
var G__51687 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__51688 = (i + (1));
m = G__51687;
i = G__51688;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51555 = p.children;
return module$node_modules$react$index.Children.toArray(G__51555);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51557 = c;
var G__51557__$1 = (((G__51557 == null))?null:G__51557.prototype);
if((G__51557__$1 == null)){
return null;
} else {
return G__51557__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51563 = c;
var G__51563__$1 = (((G__51563 == null))?null:G__51563.prototype);
if((G__51563__$1 == null)){
return null;
} else {
return G__51563__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__51699__delegate = function (args){
var G__51572 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51572) : reagent.impl.component.as_element.call(null,G__51572));
};
var G__51699 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51700__i = 0, G__51700__a = new Array(arguments.length -  0);
while (G__51700__i < G__51700__a.length) {G__51700__a[G__51700__i] = arguments[G__51700__i + 0]; ++G__51700__i;}
  args = new cljs.core.IndexedSeq(G__51700__a,0,null);
} 
return G__51699__delegate.call(this,args);};
G__51699.cljs$lang$maxFixedArity = 0;
G__51699.cljs$lang$applyTo = (function (arglist__51701){
var args = cljs.core.seq(arglist__51701);
return G__51699__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__51576 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51577 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51577);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51576);
}});
...
var c = this;
var G__51590_51707 = goog.object.get(c,"cljsRatom");
if((G__51590_51707 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51590_51707);
}
...
var renders_51712 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_51713 = cljs.core.first(cljs.core.vals(renders_51712));
...
if((cljs.core.count(renders_51712) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51712))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51713)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51713], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51625 = o;
var G__51626_51721 = G__51625;
var G__51627_51722 = cljs.core.name(k);
var G__51628_51723 = v;
goog.object.set(G__51626_51721,G__51627_51722,G__51628_51723);
...
var G__51656_51724 = cmp.prototype;
var G__51657_51725 = module$node_modules$react$index.Component.prototype;
var G__51658_51726 = methods$;
goog.object.extend(G__51656_51724,G__51657_51725,G__51658_51726);
...
var name = (function (){var G__51659 = fiber;
var G__51659__$1 = (((G__51659 == null))?null:G__51659.type);
if((G__51659__$1 == null)){
return null;
} else {
return G__51659__$1.displayName;
}
})();
var parent = (function (){var G__51660 = fiber;
if((G__51660 == null)){
return null;
} else {
return G__51660.return;
}
})();
var path = (function (){var G__51661 = parent;
var G__51661__$1 = (((G__51661 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__51661) : reagent.impl.component.fiber_component_path.call(null,G__51661)));
if((G__51661__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51661__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__51667 = c;
if((G__51667 == null)){
return null;
} else {
return goog.object.get(G__51667,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51668._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__51670 = c;
if((G__51670 == null)){
return null;
} else {
return goog.object.get(G__51670,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__51672 = c;
if((G__51672 == null)){
return null;
} else {
return G__51672._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__51677 = instance;
if((G__51677 == null)){
return null;
} else {
return goog.object.get(G__51677,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__51679 = instance;
if((G__51679 == null)){
return null;
} else {
return G__51679._currentElement;
}
}
})();
var name = (function (){var G__51680 = elem;
var G__51680__$1 = (((G__51680 == null))?null:G__51680.type);
if((G__51680__$1 == null)){
return null;
} else {
return G__51680__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__51682 = elem;
if((G__51682 == null)){
return null;
} else {
return goog.object.get(G__51682,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51683._owner;
}
}
})();
var path = (function (){var G__51684 = owner;
var G__51684__$1 = (((G__51684 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__51684) : reagent.impl.component.component_path.call(null,G__51684)));
if((G__51684__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51684__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__51685 = c;
var G__51685__$1 = (((G__51685 == null))?null:G__51685.constructor);
if((G__51685__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__51685__$1);
}
}
})();
